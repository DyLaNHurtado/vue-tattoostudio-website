  ...
  <div class="info-section">
    <div class="icon-title">
      ...
      <div class="graphic-container">
        ...
        <span class="round-icon-container"><font-awesome-icon :icon="['fas', 'comments']" class="header-icon"/></span>
        <div class="point-separator"></div>
      </div>
    </div>
    <div class="info-content">
      <p>Elige el metodo que mejor te venga para contactar con nosotros, te contestaremos de inmediato lo antes posible.</p>
      ...
      <button class="primary-button" > <font-awesome-icon :icon="['fab', 'instagram']" class="icon"/> Privado/MD por Instagram</button>
    </div>
...
<div class="info-section">
    <div class="icon-title">
      ...
      <div class="graphic-container">
        <div class="point-separator"></div>
        <span class="round-icon-container"><font-awesome-icon :icon="['fas', 'location-dot']" class="header-icon"/></span>
        <div class="point-separator"></div>
      </div>
    </div>
    <div class="info-content">
...
<div class="info-section">
    ...
    <div class="info-content">
      ...
      <div class="important-note">
        ...
        <p class="padding-left">Los dias festivos y los meses Agosto / Septiembre consultar la disponibilidad, es posible que estemos cerrados por vacaciones.</p>
      </div>
    </div>
</div>
</div>
